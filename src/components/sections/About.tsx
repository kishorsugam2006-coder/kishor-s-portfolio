    ...
    <section id="about" className="py-20 md:py-28 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
          ...
          {/* RIGHT: Bio Narrative */}{" "}
          <div 
            className="lg:col-span-7 space-y-6 glass-panel card-glow p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xl relative overflow-hidden"
            style={{ background: "linear-gradient(120deg, rgba(207,232,255,0.85) 0%, rgba(216,244,245,0.85) 25%, rgba(221,212,255,0.85) 50%, rgba(240,215,255,0.85) 75%, rgba(248,220,232,0.85) 100%)" }}
          >
            {" "}
            <div className="relative z-10 space-y-6">
              ...
              <div 
                className="p-4 rounded-2xl border border-white/40 space-y-2 relative overflow-hidden shadow-sm"
                style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.5) 0%, rgba(221,212,255,0.3) 50%, rgba(207,232,255,0.4) 100%)" }}
              >
                {" "}
              ...
              <div className="pt-4 border-t border-slate-300/50 grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                {" "}
